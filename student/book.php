                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="book.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from books where bookID='$s' or bookname like '%$s%'";
                                        }
                                    else
                                        $sql="select * from books order by availability DESC";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center><a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-primary">Details</a>
                                      	<?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue-request.php?id=".$bookid."\" class=\"btn btn-success\">Issue</a>";
                                        ?>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
