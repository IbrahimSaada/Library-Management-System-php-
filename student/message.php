                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="current-borrowedbooks.php"><i class="menu-icon icon-list"></i>Currently Issued Books </a></li>
                            </ul>
                            <ul class="widget widget-menu unstyled">
                    ...
                    <div class="span9">
                        <table class="table" id = "tables">
                            ...
                            $sql="select * from message where username='$username' order by date DESC,time DESC";
