            ...
            <div class="container">
                <div class="row">
                  ...
                  <form class="form-horizontal row-fluid" action="book.php" method="post">
                                    ...
                                    {
                                       $s=$_POST['title'];
                                           $sql = "SELECT * FROM books WHERE bookname='$s' OR bookname LIKE '%$s%'"; 
                                    }else{
                                    ...
                                    if(!($rowcount)){
                                        ...
                                        echo '<script>window.location.hash = "#title";</script>';}
                                    else
                                    {
                                    ...
                                    <tr>
                                      ...
                                      <td><b><?php echo $avail ?></b></td>
                                        <td><center>
                                            ...
                                            <a href="edit-books-details.php?id=<?php echo $bookid; ?>" class="btn btn-success">Edit</a>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
