            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index-admin.php">LMS </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="IssueReturn-Request.php"><i class="menu-icon icon-tasks"></i>Issue/Return Requests </a></li>
                    ...
                    <div class="span9">
                        ...
                        <a href="returnedbooks.php" class="btn btn-info">Returned Books</a>
                        </center>
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select * from issuerequests,books where issuerequests.BookID=books.BookID order by issuedate";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($avail > 0)
                                        {echo "<a href=\"accept.php?id1=".$bookid."&id2=".$username."&id3=".$formattedDate."&id4=".$avail."\" class=\"btn btn-success\">Accept</a>";}
                                         ?>
                                        <a href="reject.php?id1=<?php echo $bookid ?>&id2=<?php echo $username ?>" class="btn btn-danger">Reject</a>
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
...
<div class="footer">
        ...
        <script>window.location.hash = "#tables";</script>
    </body>
