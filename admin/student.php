                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from user where (username='$s' OR username like '%$s%') AND role='user';";
                                        }
                                    else
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="student-details.php?id=<?php echo $username; ?>" class="btn btn-success">Details</a>
                                            <!--a href="remove_student.php?id=<?php echo $username; ?>" class="btn btn-danger">Remove</a-->
                                      </center>
                                        </td>
                                    </tr>
                            <?php }} ?>
