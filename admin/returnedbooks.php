...
if (mysqli_num_rows($getUserResult) > 0) {
       if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT borrowedbooks.*, books.bookname
                    ...
                    OR borrowedbooks.bookID LIKE '$searchTerm%') AND borrowedbooks.returndate IS NOT NULL;";
    } else {
        $sql = "SELECT borrowedbooks.*, books.bookname
                    FROM borrowedbooks, books
                    WHERE borrowedbooks.bookID = books.bookID AND borrowedbooks.returndate IS NOT NULL;";
    }
...
<body>
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                </a><a class="brand" href="index-admin.php">LMS </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <form class="form-horizontal row-fluid" action="borrowedbooks.php" method="post" id="se">
                        <div class="control-group">
                            <label class="control-label" for="Search"><b>Search:</b></label>
                            <div class="controls">
                                <input type="text" id="title" name="title"
                                    placeholder="Enter username/Book ID." class="span8" required>
    ...
    <script>window.location.hash = "#se";</script>
<?php }
else {
