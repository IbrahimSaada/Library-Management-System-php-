            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        <center>
                            <div class="card" style="width: 50%;"> 
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                    <i>
                                    <h1 class="card-title"><center><?php echo $checkusername ?></center></h1>
                                    <br>
                                    <p><b>Email ID: </b><?php echo $email ?></p>
                                    <br>
                                    <p><b>Mobile number: </b><?php echo $phoneNumber ?></p>
                                    <br>
                        ...
                        <br>
                        <a href="edit-admin-details.php" class="btn btn-primary">Edit Details</a>
                        </center>               
                    </div>
